...
//ziyaretçi
if (!$my->id) {
include_once(ABSPATH. '/user/login.php');
}
//kayıtlı kullanıcı
else {
	//sistem yöneticisi ise 
	if ($my->access_type == 'admin') {    
		require_once(ABSPATH.'/admin/includes/admin-functions.php');    
			
		include_once(ABSPATH.'/admin/template/index.php');
			
	} else {
		require_once(ABSPATH.'/includes/functions.php');
		
		include_once(ABSPATH.'/site/template/index.php');
	}
}
