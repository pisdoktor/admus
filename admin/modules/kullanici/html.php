...
class KullaniciHTML {
	static function editKullanici($row, $lists) {
		?>
...
<table width="100%">
  ...
  <tr>
	...
	<td width="70%">
	<input type="text" name="sicilno" class="inputbox" value="<?php echo $row->sicilno;?>">
	</td>
  </tr>
  <tr>
	<td width="30%">
  ...
  <tr>
	<td width="30%">
	<strong>Kullanıcı Kurumu:</strong>
	</td>
	<td width="70%">
	<?php echo $lists['kurum'];?>
	</td>
  </tr>
   <tr>
	<td width="30%">
...
<input type="hidden" name="bolum" value="kullanici" />
...
<td width="10%">
<center>
<a href="index.php?option=yonetim&bolum=kullanici&task=editx&id=<?php echo $row->id;?>">
<?php echo $row->name;?>
</a>
</center>
</td>
...
<?php 
$link = 'index.php?option=yonetim&bolum=kullanici';
