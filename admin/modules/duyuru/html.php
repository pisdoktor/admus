...
class DuyuruHTML {
	static function editDuyuru($row, $lists) {
		?>
...
if ($row->group == '1') {
	...
	$hedef = 'Doktorlara Duyuru';
} else if ($row->group == '3') {
	$hedef = 'Kolluklara Duyuru';
} else if ($row->group == '4') {
	$hedef = 'Savcılara Duyuru';
}
?>
...
<td width="10%">
<center>
<a href="index.php?option=yonetim&bolum=duyuru&task=editx&id=<?php echo $row->id;?>"><?php echo $row->tarih;?></a>
</center>
</td>
<td width="15%">
<?php echo $hedef;?>
...
<?php 
$link = 'index.php?option=yonetim&bolum=duyuru';
